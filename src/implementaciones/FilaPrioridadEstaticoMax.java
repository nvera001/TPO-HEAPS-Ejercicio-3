...
public class FilaPrioridadEstaticoMax implements FilaPrioridadTDA{
    ...
    private void flotar(int i) { //Se ordena la fila
    ...
    public int eliminar() {
        int eliminado = elementos[0].prioridad; //Guarda el primer elemento de la fila, en este caso la prioridad mas grande.
